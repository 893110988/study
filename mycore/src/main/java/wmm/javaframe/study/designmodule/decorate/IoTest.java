package wmm.javaframe.study.designmodule.decorate;
...
public class IoTest {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        //文件路径可自行更换
        final String filePath = (IoTest.class.getResource("/")).getPath()+"//test.txt";
                //System.getProperty("user.dir")+"\\mycore\\target\\classes\\test.txt";
        System.out.println((IoTest.class.getResource("")).getPath());
